...
type SpeakerImageKey = keyof typeof speakerImages;
...
export default function SpeakersSection() {
  ...
  return (
    <section
      id="speakers"
      className="mx-auto max-w-6xl px-8 md:px-4 py-12 md:py-16"
    >
      ...
      <div className="mt-4 md:ml-6 flex overflow-x-auto gap-6 pt-4 pb-8 -mb-4">
        {speakers.map((speaker) => (
          ...
          >
            ...
            />
            <div className="p-4">
              <h3 className="md:text-lg font-semibold text-gray-900 whitespace-pre-line md:whitespace-normal">
                {speaker.name}
              </h3>
